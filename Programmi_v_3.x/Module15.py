""" Troviamo i divisori di un numero. """

# Inizializzo la variabile.
i = 1

# Chiediamo in input di inserire un valore con la virgola di cui si vuole sapere
# i divisori.
...
# Impostiamo un ciclo che riesegue il blocco di istruzioni finche' i non diventa
