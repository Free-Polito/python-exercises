""" Calcoliamo una somma, facendo inserire i numeri con un ciclo. """
...
while a != 0 :
        ...
        # Con una richiesta di inserimento gli chiediamo quale numero vuole
        # inserire.
        a = float (input('Numero? '))
        # Aggiungiamo a somma,che all'inizio e' 0 sempre il valore di a che
        # inserisce.
        somma = somma + a
